...
public class CoinController {
    ...
    ResponseEntity<JsonNode> getMarketChart(@PathVariable String coindId,@RequestParam("days") int days) throws Exception {
        String marketChart = coinService.getMarketChart(coindId, days);
